...
function TopVJPage() {
    ...
    // console.log("  topVJListAll", topVJListAll)
    ...
    return (
        ...
        >
            ...
            >
                ...
                {isLoadingTopVJListAll ? [...Array(3)].map((_, index) => (
                    <Grid
                        key={index}
                ...
                )) : topVJListAll && topVJListAll.data.length === 0 ? (
                    <Grid size={{ xs: 12, md: 12 }} style={{ textAlign: 'center' }} >
                        <Boxdata />
                    </Grid>
                ) :
                    ...
                    topVJListAll && topVJListAll.data
                        .slice(0, 4)
                        .map((item: TopVJModelDetail, index: number) => (

                            // <Grid key={index} size={{ xs: 12,  md: 3 }} style={{ textAlign: 'center' }} >
                ...
                <Grid mt={2} size={{ xs: 12, md: 12 }} style={{ textAlign: 'center' }} >
                    ...
                    <Button
                        ...
                        variant="outlined"
                        onClick={() => router.push('/home/vj_star_live')}
