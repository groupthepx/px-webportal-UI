...
export function themeCreator(primaryColor: string): Theme {
  return createTheme({
    ...PureLightTheme,
    palette: {
      ...PureLightTheme.palette,
      primary: {
        light: PureLightTheme.palette.primary.light,
        main: primaryColor,
        dark: PureLightTheme.palette.primary.dark,
      },
    },
  });
}
