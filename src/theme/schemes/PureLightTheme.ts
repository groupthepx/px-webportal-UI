...
const colors = {
  gradients: {
    primary: 'linear-gradient(135deg, #EEA15D 0%, #F1592A 51% , #9F3025 100%)',
    primaryHover: 'linear-gradient(135deg, #9F3025 0%, #F1592A 51% , #EEA15D 100%)',
  ...
  gray: {
    lighter: lighten(themeColors.gray, 0.85),
    light: lighten(themeColors.gray, 0.3),
    main: themeColors.gray,
    dark: darken(themeColors.gray, 0.2)
  },
  black: {
...
export const PureLightTheme = createTheme({
  ...
  colors: {
    gradients: {
      ...
      primaryHover: colors.gradients.primaryHover,
    ...
    gray : {
      lighter: alpha(themeColors.gray, 0.1),
      light: lighten(themeColors.gray, 0.3),
      main: themeColors.gray,
      dark: darken(themeColors.gray, 0.2),
    },
  ...
  typography: {
    fontFamily:
      '"NotoSansThai", "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
    h1: {
      fontWeight: 700,
      fontSize: 35
    },
